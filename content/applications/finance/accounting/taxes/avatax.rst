...
.. list-table::
   ...
   * - :guilabel:`Avatax for geo localization`
     ...
     - This module includes the features required for integration of AvaTax into geo-localization in
       Odoo.
   ...
   * - :guilabel:`Avatax for Inventory`
     ...
     - Includes tax calculation on Odoo Inventory.
   ...
   * - :guilabel:`Avatax Brazil for Services`
     ...
     - This module includes the features required for tax calculation for services in the Brazil
       localization.
   * - :guilabel:`Avatax Brazil Sale for Services`
     - `l10n_br_edi_sale_services`
     - This module includes the features required for tax calculation for the sale of services in
       the Brazil localization.
   * - :guilabel:`Test SOs for the Brazilian AvaTax`
     - `l10n_br_test_avatax_sale`
     - This module includes the features required for test sales orders in the Brazil localization.
...
.. tip::
   To install AvaTax for Brazil, click :guilabel:`Install` on the :guilabel:`AvaTax Brazil` module.
   This action will install :guilabel:`AvaTax Brazil` and :guilabel:`AvaTax Brazil for Services`.
